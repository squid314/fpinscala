...
object TreeCode {
  def callme() {
    ...
    val line  = Branch(Leaf(0),Branch(Leaf(1),Branch(Leaf(2),Branch(Leaf(3),Branch(Leaf(4),Branch(Leaf(5),Branch(Leaf(6),Leaf(7))))))))
    val bal   = Branch(Branch(Branch(Leaf(0),Leaf(1)),Branch(Leaf(2),Leaf(3))),Branch(Branch(Leaf(4),Leaf(5)),Branch(Leaf(6),Leaf(7))))
